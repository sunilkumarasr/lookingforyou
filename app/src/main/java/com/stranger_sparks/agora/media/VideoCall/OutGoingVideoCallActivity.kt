package com.stranger_sparks.agora.media.VideoCall
...
//        "007eJxTYDDp3SWzb5uimNhB/V+mL5lvLmFi/xjmUq06+8V/76bHa+YoMJimJVkamZlaWiamJpkkJRpbGiYbWRqZmCcnGyeZpZkbKnYuTG4IZGRgnyjPxMgAgSA+D0NBYkFiZWJyfkpqUTEDAwAi+yGx"
    ...
    private var subscriptionVideoTime = ""
    private var exitVideoTime = "00:00:00"
    ...
    private lateinit var binding: OutgoingVideoCallBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        (this.application as StrangerSparksApplication).applicationComponent.inject(this)
        binding = OutgoingVideoCallBinding.inflate(layoutInflater)
        ...
        subscriptionVideoTime = intent.getStringExtra("subscriptionVideoTime").toString()
