...
import com.stranger_sparks.databinding.ActivityIncomingVideoCallsBinding
...
class IncomingVideoCallsActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityIncomingVideoCallsBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityIncomingVideoCallsBinding.inflate(layoutInflater)
