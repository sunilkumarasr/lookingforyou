...
class StrangerSparksRepository @Inject constructor(private val apiService: StrangerSparksApiInterface) {
    ...
    fun galleryImage(
        user_id: RequestBody,
        image_outlet: List<MultipartBody.Part>
    ...
    fun addOnlineWalletAmount(
        ...
        return apiService.addOnlineWalletAmount(
            razorpay_order_id,
            razorpay_payment_id,
            razorpay_signature,
            bank,
    ...
    fun checkPayment(
        ...
        return apiService.razorpayCallback(
            amount,
            razorpay_order_id,
            razorpay_payment_id,
            razorpay_signature
    ...
    fun getVersionControl(version: String): Call<SuggestionVersionResponse> {
        return apiService.getVersionControl(version)
    }
    ...
    fun getCallStatus(user_id: String): Call<CallCancelModal> {
        return apiService.getCallStatus(user_id)
    }

    fun callCancelAPI(user_id: String, type: String): Call<CallCancelModal> {
        return apiService.submitCallCheckStatus(user_id, type)
    }
    ...
    fun userstartcall(
        ...
        profile_id: String,
        type: String
    ): Call<ProfileViewDetailsResponse> {
